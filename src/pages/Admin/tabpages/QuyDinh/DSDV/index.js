...
function DSDV() {
    ...
    const columns = [
        ...
        { title: "Tên dịch vụ", key: "STT" },
        { title: "Loại dịch vụ", key: "TENBN" },
        { title: "Giá tiền", key: "TENBS" },
    ];
    ...
    return (
        <>
            ...
            <div className="row align-items-end">
                <IFSearch title={"Tìm kiếm"} size={5} />
            ...
            <div className="container-fluid py-3">
                ...
                <ListFormDSDV columns={columns} data={displayDSDK} loading={isLoading} />
                <Pagination
